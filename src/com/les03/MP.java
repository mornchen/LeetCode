...
public class MP {
    ...
    public static void main(String[] args) {
        // 测试用例1：正常匹配情况
        String haystack = "jspsadbutsad";
        String needle = "sad";

        MP mp = new MP();
        int index = mp.strStr(haystack, needle);
        System.out.println(index); // 预期输出: 0

        // 测试用例2：不匹配情况
        System.out.println(mp.strStr("leetcode", "leeto")); // 预期输出: -1

        // 测试用例3：空needle情况
        System.out.println(mp.strStr("any", "")); // 预期输出: 0
    }
